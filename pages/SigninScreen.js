...
export default function SigninScreen({ navigation }) {
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      <Button textButton="Se connecter" textColor='black' width="50 %" height="40" background="#A3FD01" onPress={handleSignin}></Button>
      <View style={styles.orContainer}>
        <View style={styles.line}></View>
        <Text style={styles.or}>ou</Text>
        <View style={styles.line}></View>
      </View>
      <Button textButton="Signup with Google" textColor='black' width="80%" height="40" background="#A3FD01" onPress={handleSignin}></Button>
